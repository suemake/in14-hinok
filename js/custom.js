...
$(function () {
    $(' #footer .top .right01 strong').on('click', function (e) {
        e.preventDefault();
        $(' #footer .top .right01 ul>li>ul').toggleClass('on')

    });

    $(' #footer .top .right02 strong').on('click', function (e) {
        e.preventDefault();
        $(' #footer .top .right02 ul>li>ul').toggleClass('on')
